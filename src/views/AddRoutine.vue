  ...
  <div class="pb-[100px] box">
    ...
    <div class="space-y-[30px]" v-else>
      <div class="space-y-[10px]">
        ...
        <div
          class="w-full gap-[8px] flex items-center py-[10px] px-[15px] border-b border-b-[#E2E8F0]"
        >
          <input
      ...
      <div class="space-y-[20px]">
        ...
        <div
          class="w-full gap-[8px] flex items-center py-[10px] px-[15px] rounded-[8px] border border-[#E2E8F0]"
        >
        ...
        <div class="grid grid-cols-2 gap-[15px]">
          <div
            v-for="exercice in filteredExercises"
            :key="exercice.id"
          ...
          >
            ...
            <Button
              ...
              class="w-full"
              :class="{
                'bg-green-500': isSelected(exercice),
                '': !isSelected(exercice),
              }"
